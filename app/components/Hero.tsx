    ...
    <section className=" px-4 py-6 lg:px-8">
      <div className="max-w-[1320px] mx-auto">
        <div className="font-bold uppercase text">
          <h1 className="font-black text-[209.5px] leading-[0.8] tracking-normal uppercase text-center">
        ...
        <div className="relative mt-10 rounded-3xl overflow-hidden shadow-2xl h-[600px] lg:h-[700px]">
          ...
          />
          {/* Left Badge */}
          <div className="absolute left-0 top-40 -translate-y-1/2 bg-[#232321] font-semibold text-[#E7E7E3] p-4 rounded-r-md z-20">
